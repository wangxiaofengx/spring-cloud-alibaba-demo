...
public class RocketMQSendTest {
    ...
    public void producer() throws MQClientException, MQBrokerException, RemotingException, InterruptedException {
        ...
        DefaultMQProducer producer = new DefaultMQProducer("myproducer-group1");
        //2. 指定Nameserver地址
        ...
        for (int i = 0; i < messageCount; i++) {
            ...
            SendResult sendResult = producer.send(msg, (mqs, msg1, arg) -> mqs.get((Integer) arg), 3);
            System.out.println(sendResult);
            countDownLatch.countDown();
//            producer.send(msg, (mqs, msg12, arg) -> mqs.get(0), 0, new SendCallback() {
//                @Override
